    ...
    def __init__(self, *args, **kwargs):
        ...
        self.helper.layout = Layout(
            Row(
                ...
                Column(Field('country', css_class='bg-dark text-light'), css_class='col-12 col-md-5 col-lg-5'),
                css_class="d-flex justify-content-center",
            ),
            Row(
                Column(HTML('Title: '), css_class='col-auto'),
                Column(Field('title', css_class='bg-dark text-light'), css_class='col-12 col-md-6 col-lg-6'),
                css_class="d-flex justify-content-center",
            ),
            Row(
